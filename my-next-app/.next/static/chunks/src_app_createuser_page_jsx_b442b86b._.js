(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_createuser_page_jsx_b442b86b._.js", {
...
function Page() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8080/createuser", formData);
            console.log(res);
            router.push("/users");
        } catch (err) {
            console.log(err);
...
_s(Page, "GDoAPQ/0fzcPqgOURng2mtmH20g=", false, function() {
    return [
...
//# sourceMappingURL=src_app_createuser_page_jsx_b442b86b._.js.map